...
enum { GHB_CANCEL_NONE, GHB_CANCEL_ALL, GHB_CANCEL_CURRENT, GHB_CANCEL_FINISH };
...
void ghb_settings_copy(GhbValue *settings, const gchar *key,
...
int ghb_ui_update(signal_user_data_t *ud, const gchar *name,
                  const GhbValue *value);
int ghb_ui_update_from_settings(signal_user_data_t *ud, const gchar *name,
                                const GhbValue *settings);
int ghb_ui_settings_update(signal_user_data_t *ud, GhbValue *settings,
                           const gchar *name, const GhbValue *value);

...
static inline void ghb_widget_get_preferred_width(GtkWidget *widget,
                                                  gint *min_width,
                                                  gint *natural_width) {
#if GTK_CHECK_VERSION(3, 90, 0)
...
static inline void ghb_widget_get_preferred_height(GtkWidget *widget,
                                                   gint *min_height,
                                                   gint *natural_height) {
#if GTK_CHECK_VERSION(3, 90, 0)
  GtkRequisition min_req, nat_req;
...
static inline void ghb_surface_set_geometry_hints(GhbSurface *surface,
...
#if GTK_CHECK_VERSION(3, 90, 0)
static inline void ghb_image_set_from_icon_name(GtkImage *image,
                                                const gchar *name,
                                                GtkIconSize size) {
...
static inline GtkWidget *ghb_image_new_from_icon_name(const gchar *name,
                                                      GtkIconSize size) {
  GtkWidget *image;
...
static inline GtkWidget *ghb_button_new_from_icon_name(const gchar *name) {
  return gtk_button_new_from_icon_name(name);
}

static inline GtkWidget *ghb_scale_button_new(gdouble min, gdouble max,
                                              gdouble step,
                                              const gchar **icons) {

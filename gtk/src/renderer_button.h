 ...
 *  is a c++ keyword */
#define CUSTOM_TYPE_CELL_RENDERER_BUTTON                                       \
  (custom_cell_renderer_button_get_type())
#define CUSTOM_CELL_RENDERER_BUTTON(obj)                                       \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), CUSTOM_TYPE_CELL_RENDERER_BUTTON,         \
                              CustomCellRendererButton))
#define CUSTOM_CELL_RENDERER_BUTTON_CLASS(klass)                               \
  (G_TYPE_CHECK_CLASS_CAST((klass), CUSTOM_TYPE_CELL_RENDERER_BUTTON,          \
                           CustomCellRendererButtonClass))
#define CUSTOM_IS_CELL_BUTTON_BUTTON(obj)                                      \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), CUSTOM_TYPE_CELL_RENDERER_BUTTON))
#define CUSTOM_IS_CELL_BUTTON_BUTTON_CLASS(klass)                              \
  (G_TYPE_CHECK_CLASS_TYPE((klass), CUSTOM_TYPE_CELL_RENDERER_BUTTON))
#define CUSTOM_CELL_RENDERER_BUTTON_GET_CLASS(obj)                             \
  (G_TYPE_INSTANCE_GET_CLASS((obj), CUSTOM_TYPE_CELL_RENDERER_BUTTON,          \
                             CustomCellRendererButtonClass))

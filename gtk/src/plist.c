...
static void start_element(GMarkupParseContext *ctx, const gchar *name,
...
static void indent_fprintf(FILE *file, gint indent, const gchar *fmt, ...) {
  va_list ap;
...
static void gval_write(FILE *file, GhbValue *gval) {

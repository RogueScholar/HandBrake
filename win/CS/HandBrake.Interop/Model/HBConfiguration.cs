// --------------------------------------------------------------------------------------------------------------------
// <copyright file="HBConfiguration.cs" company="HandBrake Project
// (http://handbrake.fr)">
...
namespace HandBrake.Interop.Model {
  public class HBConfiguration {
    ...
    /// </summary>
    public VideoScaler ScalingMode {
      get;
      set;
    }
    ...
    /// <summary>
    /// Gets or sets a value indicating whether we use in-process or
    /// out-of-process encoding.
    /// </summary>
    ...
    public bool EnableQsvEncoder {
      get;
      set;
    }

    public bool EnableQsvLowPower {
      get;
      set;
    }
  }

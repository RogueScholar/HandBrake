// --------------------------------------------------------------------------------------------------------------------
// <copyright file="LanguageUtilities.cs" company="HandBrake Project
// (http://handbrake.fr)">
...
namespace HandBrake.Interop.Utilities {
  ...
  public class LanguageUtilities {
    ...
    public static IDictionary<string, string>MapLanguages() {
      ...
      languageMap = new Dictionary<string, string>{{Any, "any"},
                                                   {"(Unknown)", "und"},
                                                   {"Afar", "aar"},
                                                   {"Abkhazian", "abk"},
                                                   {"Afrikaans", "afr"},
    ...
    GetLanguageCodes(IEnumerable<string>userLanguages) {
    ...
    public static List<string>GetLanguageNames(IList<string>languageCodes) {
      ...
      foreach(var item in languageCodes) {
        KeyValuePair<string, string>name = MapLanguages().FirstOrDefault(
            v => v.Value == item); // Slightly inefficient but small set anyway
                                   // so not a big issue.
        names.Add(name.Key);
      }
    ...
    public static List<string>OrderIsoCodes(List<string>iso6392Codes,
                                            IList<string>userLanguages) {
      ...
      List<string>unorderedSet =
          iso6392Codes.Where(isoCode => !orderedSet.Contains(isoCode)).ToList();

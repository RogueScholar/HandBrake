// --------------------------------------------------------------------------------------------------------------------
// <copyright file="HandBrakeEncoderHelpers.cs" company="HandBrake Project
// (http://handbrake.fr)">
  ...
  public static class HandBrakeEncoderHelpers {
    ...
    static HandBrakeEncoderHelpers() {
      ...
      if (!HandBrakeUtils.IsInitialised()) {
        throw new Exception(
            "Please Initialise with HandBrakeUtils.EnsureGlobalInit before using!");
      }
    }
    ...
    public static List<HBAudioEncoder>AudioEncoders {
      get {
        if (audioEncoders == null) {
          audioEncoders =
              InteropUtilities.ToListFromIterator<hb_encoder_s, HBAudioEncoder>(
                  hbFunctions.hb_audio_encoder_get_next,
                  HandBrakeUnitConversionHelpers.NativeToAudioEncoder);
        }
    ...
    public static List<HBVideoEncoder>VideoEncoders {
      get {
        if (videoEncoders == null) {
          videoEncoders =
              InteropUtilities.ToListFromIterator<hb_encoder_s, HBVideoEncoder>(
                  hbFunctions.hb_video_encoder_get_next,
                  HandBrakeUnitConversionHelpers.NativeToVideoEncoder);
        }
    ...
    public static List<HBRate>VideoFramerates {
      get {
        if (videoFramerates == null) {
          videoFramerates =
              InteropUtilities.ToListFromIterator<hb_rate_s, HBRate>(
                  hbFunctions.hb_video_framerate_get_next,
                  HandBrakeUnitConversionHelpers.NativeToRate);
        }
    ...
    public static List<HBMixdown>Mixdowns {
      get {
        if (mixdowns == null) {
          mixdowns =
              InteropUtilities.ToListFromIterator<hb_mixdown_s, HBMixdown>(
                  hbFunctions.hb_mixdown_get_next,
                  HandBrakeUnitConversionHelpers.NativeToMixdown);
        }
    ...
    public static List<int>AudioBitrates {
      get {
        if (audioBitrates == null) {
          audioBitrates = InteropUtilities.ToListFromIterator<hb_rate_s, int>(
              hbFunctions.hb_audio_bitrate_get_next, b => b.rate);
        }
    ...
    public static List<HBRate>AudioSampleRates {
      get {
        if (audioSampleRates == null) {
          audioSampleRates =
              InteropUtilities.ToListFromIterator<hb_rate_s, HBRate>(
                  hbFunctions.hb_audio_samplerate_get_next,
                  HandBrakeUnitConversionHelpers.NativeToRate);
        }
    ...
    public static List<HBContainer>Containers {
      get {
        if (containers == null) {
          containers =
              InteropUtilities.ToListFromIterator<hb_container_s, HBContainer>(
                  hbFunctions.hb_container_get_next,
                  HandBrakeUnitConversionHelpers.NativeToContainer);
        }
    ...
    public static bool CanBurnSrt {
      get {
        return hbFunctions.hb_subtitle_can_burn(
                   (int) hb_subtitle_s_subsource.IMPORTSRT) > 0;
      }
    }
    ...
    public static bool CanBurnSSA {
      get {
        return hbFunctions.hb_subtitle_can_burn(
                   (int) hb_subtitle_s_subsource.IMPORTSSA) > 0;
      }
    }
    ...
    public static HBAudioEncoder GetAutoPassthruEncoder(int inputCodec,
                                                        int copyMask,
                                                        int fallback,
                                                        int muxer) {
      int encoder = HBFunctions.hb_autopassthru_get_encoder(
          inputCodec, copyMask, fallback, muxer);
    ...
    /// <summary>
    /// Returns true if the subtitle type can be passed through using the given
    /// muxer.
    /// </summary>
    ...
    /// </returns>
    public static bool SubtitleCanPassthrough(int subtitleSourceType,
                                              int muxer) {
    ...
    /// </remarks>
    public static bool AudioEncoderIsCompatible(int codecId,
    ...
    /// </returns>
    public static bool MixdownHasCodecSupport(HBMixdown mixdown,
                                              HBAudioEncoder encoder) {
      return hbFunctions.hb_mixdown_has_codec_support(mixdown.Id,
                                                      (uint) encoder.Id) > 0;
    }
    ...
    public static bool MixdownIsSupported(HBMixdown mixdown,
                                          HBAudioEncoder encoder,
                                          long channelLayout) {
      return hbFunctions.hb_mixdown_is_supported(mixdown.Id, (uint) encoder.Id,
                                                 (uint) channelLayout) > 0;
    }

    /// <summary>
    /// Determines if DRC can be applied to the given track with the given
    /// encoder.
    /// </summary>
    ...
    /// </returns>
    public static bool CanApplyDrc(IntPtr handle, int trackNumber,
                                   HBAudioEncoder encoder, int title) {
      return hbFunctions.hb_audio_can_apply_drc2(handle, title, trackNumber,
                                                 encoder.Id) > 0;
    }
    ...
    /// </returns>
    public static HBMixdown
    SanitizeMixdown(HBMixdown mixdown, HBAudioEncoder encoder, ulong layout) {
      if (mixdown == null || encoder == null) {
        return null;
      }

      int sanitizedMixdown = hbFunctions.hb_mixdown_get_best(
          (uint) encoder.Id, layout, mixdown.Id);
    ...
    /// </returns>
    public static HBMixdown GetDefaultMixdown(HBAudioEncoder encoder,
                                              ulong layout) {
      int defaultMixdown =
          hbFunctions.hb_mixdown_get_default((uint) encoder.Id, layout);
    ...
    public static int SanitizeSampleRate(HBAudioEncoder encoder,
                                         int sampleRate) {
      return hbFunctions.hb_audio_samplerate_find_closest(sampleRate,
                                                          (uint) encoder.Id);
    }

    /// <summary>
    /// Gets the bitrate limits for the given audio codec, sample rate and
    /// mixdown.
    /// </summary>
    /// <param name="encoder">
    ...
    /// </returns>
    public static BitrateLimits GetBitrateLimits(HBAudioEncoder encoder,
                                                 int sampleRate,
                                                 HBMixdown mixdown) {
      int low = 0;
      int high = 0;

      hbFunctions.hb_audio_bitrate_get_limits((uint) encoder.Id, sampleRate,
                                              mixdown.Id, ref low, ref high);
    ...
    /// </returns>
    public static VideoQualityLimits
    GetVideoQualityLimits(HBVideoEncoder encoder) {
      float low = 0;
      float high = 0;
      float granularity = 0;
      int direction = 0;

      hbFunctions.hb_video_quality_get_limits(
          (uint) encoder.Id, ref low, ref high, ref granularity, ref direction);

      return new VideoQualityLimits(low, high, granularity, direction == 0);
    }

    /// <summary>
    /// Sanitizes an audio bitrate given the output codec, sample rate and
    /// mixdown.
    /// </summary>
    ...
    /// </returns>
    public static int SanitizeAudioBitrate(int audioBitrate,
                                           HBAudioEncoder encoder,
                                           int sampleRate, HBMixdown mixdown) {
      return hbFunctions.hb_audio_bitrate_get_best(
          (uint) encoder.Id, audioBitrate, sampleRate, mixdown.Id);
    }
    ...
    /// </returns>
    public static int GetDefaultBitrate(HBAudioEncoder encoder, int sampleRate,
                                        HBMixdown mixdown) {
      return hbFunctions.hb_audio_bitrate_get_default((uint) encoder.Id,
                                                      sampleRate, mixdown.Id);
    }
    ...
    public static RangeLimits GetAudioQualityLimits(int encoderId) {
      ...
      int direction = 0;
      hbFunctions.hb_audio_quality_get_limits(
          (uint) encoderId, ref low, ref high, ref granularity, ref direction);
    ...
    public static RangeLimits GetAudioCompressionLimits(int encoderId) {
      float low = 0, high = 0, granularity = 0;
      int direction = 0;
      hbFunctions.hb_audio_compression_get_limits(
          (uint) encoderId, ref low, ref high, ref granularity, ref direction);
    ...
    public static uint
    BuildCopyMask(bool audioAllowMP3Pass, bool audioAllowAACPass,
                  bool audioAllowAC3Pass, bool audioAllowDTSPass,
                  bool audioAllowDTSHDPass, bool audioAllowEac3Pass,
                  bool audioAllowFlacPass, bool audioAllowTruehdPass) {
      uint mask = 0;

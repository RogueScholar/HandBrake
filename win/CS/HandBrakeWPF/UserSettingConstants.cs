// --------------------------------------------------------------------------------------------------------------------
// <copyright file="UserSettingConstants.cs" company="HandBrake Project
// (http://handbrake.fr)">
...
public class UserSettingConstants {
  ...
  public const string PauseQueueOnLowDiskspaceLevel =
      "LowDiskSpaceWarningLevelInBytes";
  public const string PauseEncodeOnLowDiskspaceLevel =
      "LowDiskSpaceEncodePauseLevelInBytes";
  ...
  public const string AutonameFileCollisionBehaviour =
      "AutonameFileCollisionBehaviour";
  public const string AutonameFilePrePostString = "AutonameFilePrePostString";
  public const string WhenDonePerformActionImmediately =

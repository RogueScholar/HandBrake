// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SubtitlesDefaultsView.xaml.cs" company="HandBrake Project
// (http://handbrake.fr)">
...
namespace HandBrakeWPF.Views {
  ...
  public partial class SubtitlesDefaultsView : Window {
    /// <summary>
    /// Initializes a new instance of the <see cref="SubtitlesDefaultsView"/>
    /// class.
    /// </summary>
    public SubtitlesDefaultsView() { this.InitializeComponent(); }

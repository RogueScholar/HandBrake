// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ErrorView.xaml.cs" company="HandBrake Project
// (http://handbrake.fr)">
...
namespace HandBrakeWPF.Views {
  ...
  public partial class ErrorView : Window {
    public ErrorView() {
      ...
      this.InputBindings.Add(new InputBinding(
          new CopyError(this.errorText),
          new KeyGesture(Key.C, ModifierKeys.Control))); // Copy Error
    }
  }
  ...
  public class CopyError : ICommand {
    ...
    public CopyError(TextBox textBlock) { this.textBlock = textBlock; }

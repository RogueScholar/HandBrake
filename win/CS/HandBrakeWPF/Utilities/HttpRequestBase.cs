// --------------------------------------------------------------------------------------------------------------------
// <copyright file="HttpRequestBase.cs" company="HandBrake Project
// (http://handbrake.fr)">
...
namespace HandBrakeWPF.Utilities {
  ...
  public class HttpRequestBase {
    protected readonly JsonSerializerSettings jsonNetSettings =
    ...
    public async Task<ServerResponse>MakeHttpJsonPostRequest(string urlPath,
                                                             string json) {
      ...
      HttpResponseMessage response =
          await client.PostAsync(this.serverUrl + urlPath, content);
      if (response != null) {
        string returnContent = await response.Content.ReadAsStringAsync();
        ServerResponse serverResponse =
            new ServerResponse(response.IsSuccessStatusCode, returnContent);
    ...
    public async Task<ServerResponse>MakeHttpGetRequest(string urlPath) {
      HttpResponseMessage response =
          await client.GetAsync(this.serverUrl + urlPath);
      if (response != null) {
        string returnContent = await response.Content.ReadAsStringAsync();
        ServerResponse serverResponse =
            new ServerResponse(response.IsSuccessStatusCode, returnContent);

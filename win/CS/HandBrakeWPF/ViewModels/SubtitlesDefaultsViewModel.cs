// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SubtitlesDefaultsViewModel.cs" company="HandBrake Project
// (http://handbrake.fr)">
...
namespace HandBrakeWPF.ViewModels {
  ...
  /// </summary>
  public class SubtitlesDefaultsViewModel : ViewModelBase,
                                            ISubtitlesDefaultsViewModel {
...
#region Constructors and Destructors
    ...
    /// cref="SubtitlesDefaultsViewModel"/> class.
    /// </summary>
...
#region Properties
    ...
    public SubtitleBehaviours SubtitleBehaviours {
      get { return this.subtitleBehaviours; }
      set {
    ...
    public BindingList<SubtitleBehaviourModes>SubtitleBehaviourModeList {
      get {
        return new BindingList<SubtitleBehaviourModes>(
            EnumHelper<SubtitleBehaviourModes>.GetEnumList().ToList());
      }
    }
    ...
    /// </summary>
    public BindingList<SubtitleBurnInBehaviourModes>
        SubtitleBurnInBehaviourModeList {
      get {
        return new BindingList<SubtitleBurnInBehaviourModes>(
            EnumHelper<SubtitleBurnInBehaviourModes>.GetEnumList().ToList());
      }
    }
...
#region Methods
    ...
    public void SetupLanguages(SubtitleBehaviours behaviours) {
      ...
      this.SubtitleBehaviours.SelectedBurnInBehaviour =
          SubtitleBurnInBehaviourModes.None;
      ...
      if (behaviours != null) {
        this.SubtitleBehaviours.SelectedBehaviour =
            behaviours.SelectedBehaviour;
        this.SubtitleBehaviours.SelectedBurnInBehaviour =
            behaviours.SelectedBurnInBehaviour;
        this.SubtitleBehaviours.AddClosedCaptions =
            behaviours.AddClosedCaptions;

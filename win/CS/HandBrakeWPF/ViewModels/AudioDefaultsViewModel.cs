// --------------------------------------------------------------------------------------------------------------------
// <copyright file="AudioDefaultsViewModel.cs" company="HandBrake Project
// (http://handbrake.fr)">
...
#region Constructors and Destructors
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="AudioDefaultsViewModel"/>
    /// class.
    /// </summary>
    /// <param name="task">
    /// The task.
...
#region Properties
    ...
    /// <summary>
    /// Gets or sets the list of audio tracks we will use as templates for
    /// generating tracks for a given source.
    /// </summary>
    public BindingList<AudioBehaviourTrack>BehaviourTracks {
      get { return this.AudioBehaviours.BehaviourTracks; }
      set {
    ...
    public AudioBehaviours AudioBehaviours {
      get { return this.audioBehaviours; }
    ...
    /// </summary>
    public BindingList<string>SelectedAvailableToMove {
      get;
      private set;
    }
    ...
    /// Gets SelectedLangauges.
    /// </summary>
    public BindingList<string>SelectedLangaugesToMove {
      get;
      private set;
    }
    ...
    public bool AudioAllowMP3Pass {
      get { return this.Task.AllowedPassthruOptions.AudioAllowMP3Pass; }
    ...
    public bool AudioAllowAACPass {
      get { return this.Task.AllowedPassthruOptions.AudioAllowAACPass; }
    ...
    public bool AudioAllowAC3Pass {
      get { return this.Task.AllowedPassthruOptions.AudioAllowAC3Pass; }
    ...
    public bool AudioAllowEAC3Pass {
      get { return this.Task.AllowedPassthruOptions.AudioAllowEAC3Pass; }
    ...
    public bool AudioAllowDTSPass {
      get { return this.Task.AllowedPassthruOptions.AudioAllowDTSPass; }
    ...
    public bool AudioAllowDTSHDPass {
      get { return this.Task.AllowedPassthruOptions.AudioAllowDTSHDPass; }
    ...
    public bool AudioAllowTrueHDPass {
      get { return this.Task.AllowedPassthruOptions.AudioAllowTrueHDPass; }
    ...
    public bool AudioAllowFlacPass {
      get { return this.Task.AllowedPassthruOptions.AudioAllowFlacPass; }
    ...
    public AudioEncoder AudioEncoderFallback {
      get { return this.Task.AllowedPassthruOptions.AudioEncoderFallback; }
      set {
...
#region Data Properties
    ...
    public BindingList<AudioBehaviourModes>AudioBehaviourModeList {
      get {
        return new BindingList<AudioBehaviourModes>(
            EnumHelper<AudioBehaviourModes>.GetEnumList().ToList());
      }
    }
    ...
    /// </summary>
    public BindingList<AudioTrackDefaultsMode>
        AudioTrackDefaultBehaviourModeList {
      get {
        return new BindingList<AudioTrackDefaultsMode>(
            EnumHelper<AudioTrackDefaultsMode>.GetEnumList().ToList());
      }
    }
...
#region Public Methods
    ...
    /// </summary>
    public void AddTrack() { this.BehaviourTracks.AddNew(); }

    /// <summary>
    /// Clear all the behaviour tracks
    /// </summary>
    public void ClearTracks() { this.BehaviourTracks.Clear(); }
    ...
    public void LanguageMoveRight() {
      if (this.SelectedAvailableToMove.Count > 0) {
        ...
        this.AvailableLanguages = new BindingList<string>(
            this.AvailableLanguages.OrderBy(o => o).ToList());
      }
    }
    ...
    public void ResetApplied() { this.IsApplied = false; }
...
#region Methods
    ...
    public void Setup(Preset preset, EncodeTask task) {
      ...
      langList =
          (from entry in langList orderby entry.Key ascending select entry)
      ...
      if (behaviours != null) {
        ...
        this.AudioBehaviours.SelectedTrackDefaultBehaviour =
            behaviours.SelectedTrackDefaultBehaviour;

        foreach(AudioBehaviourTrack item in
                    preset.AudioTrackBehaviours.BehaviourTracks) {
      ...
      this.task.AllowedPassthruOptions =
          new AllowedPassthru(preset.Task.AllowedPassthruOptions);
    ...
    public void RefreshTask() {
      ...
      if (this.Task.OutputFormat == OutputFormat.Mp4 &&
          (this.AudioEncoderFallback == AudioEncoder.ffflac ||
           this.AudioEncoderFallback == AudioEncoder.ffflac24 ||
    ...
    public void LaunchHelp() {
      Process.Start(
          "https://handbrake.fr/docs/en/1.2.0/advanced/audio-subtitle-defaults.html");
    }

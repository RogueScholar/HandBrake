// --------------------------------------------------------------------------------------------------------------------
// <copyright file="AddPresetViewModel.cs" company="HandBrake Project
// (http://handbrake.fr)">
...
namespace HandBrakeWPF.ViewModels {
  ...
  public class AddPresetViewModel : ViewModelBase, IAddPresetViewModel {
    ...
    private readonly PresetDisplayCategory addNewCategory =
        new PresetDisplayCategory(Resources.AddPresetView_AddNewCategory, true,
                                  null);
    private bool canAddNewPresetCategory;

    /// <summary>
    /// Initializes a new instance of the <see cref="AddPresetViewModel"/>
    /// class.
    /// </summary>
    ...
    /// The window Manager.
    /// </param>
    public AddPresetViewModel(IPresetService presetService,
      ...
      this.Preset = new Preset{IsBuildIn = false, IsDefault = false,
                               Category = PresetService.UserPresetCatgoryName};
      this.PictureSettingsModes =
          EnumHelper<PresetPictureSettingsMode>.GetEnumList();
      this.PresetCategories =
          presetService.GetPresetCategories(true)
              .Union(new List<PresetDisplayCategory>{addNewCategory})
              .ToList();
      this.SelectedPresetCategory = this.PresetCategories.FirstOrDefault(
          n => n.Category == PresetService.UserPresetCatgoryName);
    }
    ...
    /// </summary>
    public IEnumerable<PresetPictureSettingsMode>PictureSettingsModes {
      get;
      set;
    }
    ...
    public bool ShowCustomInputs {
      get { return this.showCustomInputs; }
      set {
    ...
    public List<PresetDisplayCategory>PresetCategories {
      get;
      set;
    }
    ...
    public string PresetCategory {
      get { return this.Preset.Category; }
      set {
    ...
    public bool CanAddNewPresetCategory {
      get { return this.canAddNewPresetCategory; }
      set {
    ...
    public PresetPictureSettingsMode SelectedPictureSettingMode {
      get { return this.selectedPictureSettingMode; }
      set {
    ...
    public void Setup(EncodeTask task, Title title,
      ...
      this.audioDefaultsViewModel =
          new AudioDefaultsViewModel(this.Preset.Task);
      ...
      case Anamorphic.Automatic:
        this.SelectedPictureSettingMode =
    ...
    public void Add() {
      if (string.IsNullOrEmpty(this.Preset.Name)) {
        this.errorService.ShowMessageBox(
            Resources.AddPresetViewModel_PresetMustProvideName, Resources.Error,
      ...
      if (this.presetService.CheckIfPresetExists(this.Preset.Name)) {
        ...
        if (currentPreset != null && currentPreset.IsBuildIn) {
          this.errorService.ShowMessageBox(
              Resources.Main_NoUpdateOfBuiltInPresets, Resources.Error,
              MessageBoxButton.OK, MessageBoxImage.Error);
          return;
        }
      ...
      if (this.SelectedPictureSettingMode ==
              PresetPictureSettingsMode.SourceMaximum &&
          this.selectedTitle == null) {
        this.errorService.ShowMessageBox(
            Resources.AddPresetViewModel_YouMustFirstScanSource,
      ...
      if (this.CustomWidth == null && this.CustomHeight == null &&
          this.SelectedPictureSettingMode == PresetPictureSettingsMode.Custom) {
        this.errorService.ShowMessageBox(
            Resources.AddPresetViewModel_CustomWidthHeightFieldsRequired,
            Resources.Error, MessageBoxButton.OK, MessageBoxImage.Error);
        return;
      }
      ...
      if (!added) {
        this.errorService.ShowMessageBox(
            ...
            Resources.UnknownError, MessageBoxButton.OK, MessageBoxImage.Error);
      } else {
        this.Close();
      }
    }
    ...
    public void EditAudioDefaults() {
      ...
      if (audioDefaultsViewModel.IsApplied) {
        this.Preset.AudioTrackBehaviours =
            this.audioDefaultsViewModel.AudioBehaviours.Clone();
      }
    }
    ...
    public void EditSubtitleDefaults() {
      ...
      if (subtitlesDefaultsViewModel.IsApplied) {
        this.Preset.SubtitleTrackBehaviours =
            this.subtitlesDefaultsViewModel.SubtitleBehaviours.Clone();
      }
    }

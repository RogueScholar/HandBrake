// --------------------------------------------------------------------------------------------------------------------
// <copyright file="PictureSettingsViewModel.cs" company="HandBrake Project
// (http://handbrake.fr)">
...
namespace HandBrakeWPF.ViewModels {
  ...
  using PresetPictureSettingsMode =
      HandBrakeWPF.Model.Picture.PresetPictureSettingsMode;

  /// <summary>
  /// The Picture Settings View Model
  /// </summary>
  public class PictureSettingsViewModel : ViewModelBase,
...
#region Constants and Fields
    ...
    /// </summary>
    private DelayedActionProcessor delayedPreviewprocessor =
        new DelayedActionProcessor();
...
#region Constructors and Destructors
    ...
    /// cref="HandBrakeWPF.ViewModels.PictureSettingsViewModel"/> class.
    /// </summary>
...
#region Properties
    ...
    public IEnumerable<Anamorphic>AnamorphicModes {
      get {
        return new List<Anamorphic>{Anamorphic.None, Anamorphic.Automatic,
    ...
    public bool HeightControlEnabled {
      get { return this.heightControlEnabled; }
    ...
    public IEnumerable<int>ModulusValues {
      get { return new List<int>{16, 8, 4, 2}; }
    }
    ...
    public bool ShowCustomAnamorphicControls {
      get { return this.showCustomAnamorphicControls; }
    ...
    public bool WidthControlEnabled {
      get { return this.widthControlEnabled; }
    ...
    public bool ShowDisplaySize {
      get { return this.showDisplaySize; }
      set {
...
#region Task Properties
    ...
    public int CropBottom {
      get { return this.Task.Cropping.Bottom; }
    ...
    /// </summary>
    public int CropLeft {
      get { return this.Task.Cropping.Left; }
    ...
    public int CropRight {
      get { return this.Task.Cropping.Right; }
    ...
    /// </summary>
    public int CropTop {
      get { return this.Task.Cropping.Top; }
    ...
    public bool IsCustomCrop {
      get { return this.Task.HasCropping; }
    ...
    public long DisplayWidth {
      get {
        return this.Task.DisplayWidth.HasValue
                   ? int.Parse(
            Math.Round(this.Task.DisplayWidth.Value, 0)
      ...
      set {
        if (!object.Equals(this.Task.DisplayWidth, value)) {
          ...
          this.RecaulcatePictureSettingsProperties(
              ChangedPictureField.DisplayWidth);
        }
      }
    }
    ...
    /// </summary>
    public int Width {
      get { return this.Task.Width.HasValue ? this.Task.Width.Value : 0; }
    ...
    /// </summary>
    public int Height {
      get { return this.Task.Height.HasValue ? this.Task.Height.Value : 0; }
    ...
    public int ParHeight {
      get { return this.Task.PixelAspectY; }
    ...
    /// </summary>
    public int ParWidth {
      get { return this.Task.PixelAspectX; }
    ...
    public Anamorphic SelectedAnamorphicMode {
      get { return this.Task.Anamorphic; }
      ...
      set {
        if (!object.Equals(this.SelectedAnamorphicMode, value)) {
          ...
          this.RecaulcatePictureSettingsProperties(
              ChangedPictureField.Anamorphic);
...
#region Public Methods
    ...
    public void SetPreset(Preset preset, EncodeTask task) {
      ...
      case PresetPictureSettingsMode.SourceMaximum:
        ...
        if (preset.PictureSettingsMode ==
          ...
          int presetHeight =
              preset.Task.MaxHeight ?? this.sourceResolution.Height;

          this.MaxWidth =
              presetWidth <= this.sourceResolution.Width ? presetWidth
              : this.sourceResolution.Width;
          this.MaxHeight =
              presetHeight <= this.sourceResolution.Height ? presetHeight
              : this.sourceResolution.Height;
        }

        // Set the width, then check the height doesn't breach the max height
        // and correct if necessary.
        int width = this.GetModulusValue(this.GetRes(
            (this.sourceResolution.Width - this.CropLeft - this.CropRight),
            this.MaxWidth));
        int height = this.GetModulusValue(this.GetRes(
            (this.sourceResolution.Height - this.CropTop - this.CropBottom),
            this.MaxHeight));

        // Set the backing fields to avoid triggering recalulation until both
        // are set.
      ...
      case PresetPictureSettingsMode.None:
        ...
        if (this.Width > this.MaxWidth) {
          // Trigger a Recalc
          this.Task.Width = this.GetModulusValue(this.GetRes(
              (this.sourceResolution.Width - this.CropLeft - this.CropRight),
              this.MaxWidth));
          this.RecaulcatePictureSettingsProperties(ChangedPictureField.Width);
        }
      ...
      if (preset.Task.Anamorphic == Anamorphic.Custom) {
        this.DisplayWidth =
            preset.Task.DisplayWidth !=
            null ? int.Parse(preset.Task.DisplayWidth.ToString()) : 0;
    ...
    /// The task.
    /// </param>
    public void SetSource(Source source, Title title, Preset preset,
                          EncodeTask task) {
      ...
      if (title != null) {
        ...
        if (preset.PictureSettingsMode == PresetPictureSettingsMode.None) {
          this.Task.Width = this.GetModulusValue(
              this.sourceResolution.Width - this.CropLeft - this.CropRight);
          this.Task.Height = this.GetModulusValue(
              this.sourceResolution.Height - this.CropTop - this.CropBottom);
        } else if (preset.PictureSettingsMode ==
                   PresetPictureSettingsMode.SourceMaximum) {
          this.Task.Width = this.GetModulusValue(
              this.sourceResolution.Width - this.CropLeft - this.CropRight);
          this.Task.Height = this.GetModulusValue(
          ...
          // Custom
          // Set the Width, and Maintain Aspect ratio. That should calc the
          // Height for us.
          this.Task.Width = this.GetModulusValue(
              this.sourceResolution.Width - this.CropLeft - this.CropRight);
        ...
        this.SourceInfo = string.Format(
            "{0}x{1}, PAR: {2}/{3}", title.Resolution.Width,
            title.Resolution.Height, title.ParVal.Width, title.ParVal.Height);
...
#region Methods
    ...
    private PictureSize.PictureSettingsTitle GetPictureTitleInfo() {
      PictureSize.PictureSettingsTitle title =
          new PictureSize.PictureSettingsTitle{
    ...
    /// </returns>
    private PictureSize.PictureSettingsJob
    GetPictureSettings(ChangedPictureField changedField) {
      PictureSize.PictureSettingsJob job = new PictureSize.PictureSettingsJob{
        ...
        ParW =
            this.SelectedAnamorphicMode == Anamorphic.None ? 1 : this.ParWidth,
        ParH =
            this.SelectedAnamorphicMode == Anamorphic.None ? 1 : this.ParHeight,
        MaxWidth = this.MaxWidth,
        MaxHeight = this.MaxHeight,
        KeepDisplayAspect = this.MaintainAspectRatio,
        AnamorphicMode = this.SelectedAnamorphicMode,
        Crop = new Cropping(this.CropTop, this.CropBottom, this.CropLeft,
                            this.CropRight),
      };
      ...
      // Reduce the Par W/H if we can. Don't do it while the user is altering
      // the PAR controls through as it will mess with the result.
      if (changedField != ChangedPictureField.ParH &&
          changedField != ChangedPictureField.ParW) {
        long x, y;
    ...
    /// <summary>
    /// Recalculate the picture settings when the user changes a particular
    /// field defined in the ChangedPictureField enum. The properties in this
    /// class are dumb. They simply call this method if there is a change. It is
    /// the job of this method to update all affected private fields and raise
    ...
    /// </param>
    private void
    RecaulcatePictureSettingsProperties(ChangedPictureField changedField) {
      // Sanity Check
      ...
      if (changedField == ChangedPictureField.Anamorphic &&
          (this.SelectedAnamorphicMode == Anamorphic.None ||
           this.SelectedAnamorphicMode == Anamorphic.Loose)) {
        this.Task.Width =
            this.sourceResolution.Width > this.MaxWidth
                              ? this.MaxWidth
            : this.sourceResolution.Width;
        this.Task.KeepDisplayAspect = true;
      }
      ...
      // Step 2, For the changed field, call hb_set_anamorphic_size and process
      // the results.
      PictureSize.AnamorphicResult result = PictureSize.hb_set_anamorphic_size2(
          this.GetPictureSettings(changedField), this.GetPictureTitleInfo(),
          setting);
      double dispWidth = Math.Round(
          (result.OutputWidth * result.OutputParWidth / result.OutputParHeight),
          0);

      this.Task.Width = result.OutputWidth;
      this.Task.Height = result.OutputHeight;
      long x, y;
      HandBrakeUtils.Reduce((int) Math.Round(result.OutputParWidth, 0),
                            (int) Math.Round(result.OutputParHeight, 0), out x,
                            out y);
      ...
      this.DisplaySize = this.sourceResolution == null ||
                         this.sourceResolution.IsEmpty
                           ? string.Empty
          : string.Format(
                Resources.PictureSettingsViewModel_StorageDisplayLabel,
                dispWidth, result.OutputHeight, this.ParWidth, this.ParHeight);
      ...
      if (delayedPreviewprocessor != null && this.Task != null &&
          this.StaticPreviewViewModel != null &&
          this.StaticPreviewViewModel.IsOpen) {
        delayedPreviewprocessor.PerformTask(
            () => this.StaticPreviewViewModel.UpdatePreviewFrame(
                this.Task, this.scannedSource),
            800);
      }
    }
    ...
    /// <summary>
    /// For a given value, correct so that it matches the users currently
    /// selected modulus value
    /// </summary>
    /// <param name="value">
    /// The value.
    /// </param>

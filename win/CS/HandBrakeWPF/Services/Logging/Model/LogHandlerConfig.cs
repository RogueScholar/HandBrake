// --------------------------------------------------------------------------------------------------------------------
// <copyright file="LogHandlerConfig.cs" company="HandBrake Project
// (http://handbrake.fr)">
...
namespace HandBrakeWPF.Services.Logging.Model {
  public class LogHandlerConfig {
    public LogHandlerConfig(bool enableDiskLogging, string logFile,
                            bool deleteCurrentLogFirst, string header) {

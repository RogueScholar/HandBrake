...
#region Properties
    ...
    public Subtitle SourceTrack {
      ...
      set {
        ...
        if (this.sourceTrack != null) {
          this.Name = !string.IsNullOrEmpty(this.sourceTrack.Name)
                          ? this.sourceTrack.Name
                          : string.Empty;
        }
      }
    }
    ...
    public bool CanBeForced {
      get {
        if (this.SourceTrack != null) {
          return this.SourceTrack.CanForce ||
                 this.SourceTrack.SubtitleType ==
    ...
    public bool CanBeBurned {
      get {
        if (this.SourceTrack != null) {
          return this.SourceTrack.CanBurnIn ||
                 this.SourceTrack.SubtitleType ==
                     SubtitleType.ForeignAudioSearch ||
    ...
    public override string ToString() {
      return string.Format("Subtitle Track: Title {0}",
                           this.SrtFileName ?? this.SourceTrack.ToString());
    }
  }
}
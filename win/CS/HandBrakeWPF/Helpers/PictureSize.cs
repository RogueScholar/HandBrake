// --------------------------------------------------------------------------------------------------------------------
// <copyright file="PictureSize.cs" company="HandBrake Project
// (http://handbrake.fr)">
...
namespace HandBrakeWPF.Helpers {
  ...
  public class PictureSize {
    ...
    public class PictureSettingsJob {
      ...
      /// </summary>
      public Anamorphic AnamorphicMode {
        get;
        set;
      }
    ...
    hb_set_anamorphic_size2(PictureSettingsJob job, PictureSettingsTitle title,
                            KeepSetting setting) {
      ...
      hb_geometry_settings_s uiGeometry = new hb_geometry_settings_s{
        crop =
            new[]{job.Crop.Top, job.Crop.Bottom, job.Crop.Left, job.Crop.Right},
        itu_par = 0,
        keep = settingMode,
        ...
        geometry = new hb_geometry_s{height = job.Height, width = job.Width,
                                     par = computed_par}
      };
      ...
      IHbFunctionsProvider provider =
          IoC.Get<IHbFunctionsProvider>(); // TODO make this method non static
                                           // and remove IoC call.
      IHbFunctions hbFunctions = provider.GetHbFunctionsWrapper();

      hbFunctions.hb_set_anamorphic_size2(ref sourceGeometry, ref uiGeometry,
                                          ref result);
      ...
      return new AnamorphicResult{
          ...
          OutputParWidth = outputParWidth, OutputParHeight = outputParHeight};
    }
  }
}

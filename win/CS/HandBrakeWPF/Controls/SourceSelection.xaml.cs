// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SourceSelection.xaml.cs" company="HandBrake Project
// (http://handbrake.fr)">
...
namespace HandBrakeWPF.Controls {
  ...
  public partial class SourceSelection : UserControl {
    ...
    /// </summary>
    public SourceSelection() { this.InitializeComponent(); }
    ...
    /// The e.
    /// </param>
    private void AboutHandBrake_OnRequestNavigate(object sender,
    ...
    /// The e.
    /// </param>
    private void OpenOptions_OnRequestNavigate(object sender,
                                               RequestNavigateEventArgs e) {
      MainViewModel vm = this.DataContext as MainViewModel;
    ...
    /// The e.
    /// </param>
    private void Help_OnRequestNavigate(object sender,
                                        RequestNavigateEventArgs e) {
      Process.Start("https://handbrake.fr/docs");
    }

    private void UpdateAvailable_OnRequestNavigate(object sender,
                                                   RequestNavigateEventArgs e) {
      MainViewModel vm = this.DataContext as MainViewModel;
      vm.CheckForUpdates();
    }

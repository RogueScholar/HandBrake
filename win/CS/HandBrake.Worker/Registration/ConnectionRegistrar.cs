// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ConnectionRegistrar.cs" company="HandBrake Project
// (http://handbrake.fr)">
...
//  This service simply allows the UI to verify which worker process it is
//  connected to.
// </remarks>
// --------------------------------------------------------------------------------------------------------------------
    ...
    public string Pair(HttpListenerRequest request) {
      ...
      if (!string.IsNullOrEmpty(token)) {
        return JsonConvert.SerializeObject(
            new ConnectionResult(false, null, "Already Paired"),
      ...
      return JsonConvert.SerializeObject(
          new ConnectionResult(true, tokenKey, null), Formatting.Indented,
          this.jsonNetSettings);
    }

    public string GetToken(HttpListenerRequest request) { return this.token; }
  }
}

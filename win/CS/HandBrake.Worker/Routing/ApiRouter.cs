// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ApiRouter.cs" company="HandBrake Project
// (http://handbrake.fr)">
//   This file is part of the HandBrake source code - It may be used under the
//   terms of the GNU General Public License.
// </copyright>
// <summary>
//   This is a service worker for the HandBrake app. It allows us to run encodes
//   / scans in a seperate process easily. All API's expose the
//   ApplicationServices models as JSON.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace HandBrake.Worker.Routing {
  ...
  public class ApiRouter {
    private readonly JsonSerializerSettings jsonNetSettings =
    ...
    public string GetVersionInfo(HttpListenerRequest request) {
      string versionInfo = JsonConvert.SerializeObject(
          VersionHelper.GetVersion(), Formatting.Indented,
          this.jsonNetSettings);
    ...
    public string PollEncodeProgress(HttpListenerRequest request) {
      if (this.handbrakeInstance != null) {
        ...
        string versionInfo = JsonConvert.SerializeObject(
            statusJson, Formatting.Indented, this.jsonNetSettings);
    ...
    public string SetConfiguration(HttpListenerRequest request) { return null; }

    /* Logging API */

    // GET
    public string GetAllLogMessages(HttpListenerRequest request) {
      return JsonConvert.SerializeObject(this.logHandler.GetLogMessages(),
                                         Formatting.Indented,
                                         this.jsonNetSettings);
    }
    ...
    public string GetLogMessagesFromIndex(HttpListenerRequest request) {
      ...
      if (int.TryParse(requestPostData, out int index)) {
        return JsonConvert.SerializeObject(
            this.logHandler.GetLogMessagesFromIndex(index), Formatting.Indented,
            this.jsonNetSettings);
      }

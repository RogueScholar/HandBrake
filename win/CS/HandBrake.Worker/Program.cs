// --------------------------------------------------------------------------------------------------------------------
// <copyright file="Program.cs" company="HandBrake Project
// (http://handbrake.fr)">
...
namespace HandBrake.Worker {
  ...
  public class Program {
    ...
    public static Dictionary<string, Func<HttpListenerRequest, string>>
    RegisterApiHandlers() {
      Dictionary<string, Func<HttpListenerRequest, string>>apiHandlers =
      ...
      apiHandlers.Add("GetLogMessagesFromIndex",
                      router.GetLogMessagesFromIndex);

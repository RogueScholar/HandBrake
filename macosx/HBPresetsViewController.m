...
@property(nonatomic, strong)
    IBOutlet NSLayoutConstraint *headerBottomConstraint;
...
- (IBAction)exportPreset:(id)sender {
  ...
  HBPreset *selectedPreset =
      [self.treeController.selectedObjects.firstObject copy];
  ...
  [panel beginWithCompletionHandler:^(NSInteger result) {
    if (result == NSModalResponseOK) {
      ...
      NSError *error = NULL;
      BOOL success = [selectedPreset writeToURL:panel.URL
                                     atomically:YES
                                     removeRoot:NO
                                          error:&error];
      if (success == NO) {

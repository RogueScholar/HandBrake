...
static const uint8_t hb_annexb_startcode[] = {
    0x00,
    0x00,
    0x00,
    0x01,
...
size_t hb_nal_unit_write_annexb(uint8_t *buf, const uint8_t *nal_unit,
...
size_t hb_nal_unit_write_isomp4(uint8_t *buf, const uint8_t *nal_unit,
                                const size_t nal_unit_size) {
  int i;

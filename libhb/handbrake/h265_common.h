...
#define HB_HEVC_NALU_KEYFRAME(nal_unit_type)                                   \
...
static const int hb_h265_level_values[] = {
    -1, 30, 60, 63, 90, 93, 120, 123, 150, 153, 156, 180, 183, 186, 0,
};
...
static const char *const hb_h265_colorprim_names[] = {
    ...
    "smpte170m", "smpte240m", "film",  "bt2020", NULL,
};
...
static const char *const hb_h265_colmatrix_names[] = {
    "GBR",       "bt709",     "undef", "",         "fcc",     "bt470bg",
    "smpte170m", "smpte240m", "YCgCo", "bt2020nc", "bt2020c", NULL,
};

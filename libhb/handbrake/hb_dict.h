...
int hb_dict_extract_double(double *dst, const hb_dict_t *dict, const char *key);
...
/* convenience macros */
#define hb_dict_get_string(dict, key)                                          \
  hb_value_get_string(hb_dict_get(dict, key))
#define hb_dict_get_int(dict, key) hb_value_get_int(hb_dict_get(dict, key))
#define hb_dict_get_double(dict, key)                                          \
  hb_value_get_double(hb_dict_get(dict, key))
#define hb_dict_get_bool(dict, key) hb_value_get_bool(hb_dict_get(dict, key))

#define hb_dict_set_string(dict, key, val)                                     \
  hb_dict_set(dict, key, hb_value_string(val))
#define hb_dict_set_int(dict, key, val)                                        \
  hb_dict_set(dict, key, hb_value_int(val))
#define hb_dict_set_double(dict, key, val)                                     \
  hb_dict_set(dict, key, hb_value_double(val))
#define hb_dict_set_bool(dict, key, val)                                       \
  hb_dict_set(dict, key, hb_value_bool(val))

...
struct hb_buffer_settings_s {
  ...
  int new_chap; // Video packets: if non-zero, is the index of the chapter whose
...
int hb_picture_crop(uint8_t *data[], int stride[], hb_buffer_t *b, int top,
                    int left);
 ...
 **********************************************************************/
hb_thread_t *hb_scan_init(hb_handle_t *, volatile int *die, const char *path,
                          int title_index, hb_title_set_t *title_set,
...
void hb_demux_ps(hb_buffer_t *ps_buf, hb_buffer_list_t *es_list,
                 hb_psdemux_t *);
void hb_demux_ts(hb_buffer_t *ps_buf, hb_buffer_list_t *es_list,
                 hb_psdemux_t *);
void hb_demux_null(hb_buffer_t *ps_buf, hb_buffer_list_t *es_list,
                   hb_psdemux_t *);
...
#define HB_MUX_COMMON                                                          \
  ...
  int (*mux)(hb_mux_object_t *, hb_mux_data_t *, hb_buffer_t *);               \
  int (*end)(hb_mux_object_t *);

#define DECLARE_MUX(a) hb_mux_object_t *hb_mux_##a##_init(hb_job_t *);
